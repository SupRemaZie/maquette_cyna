          ...
          <div className="flex-1">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-6">
              <button
                ...
                className="lg:hidden flex items-center text-gray-700 hover:text-primary-600 px-3 py-2 border border-gray-300 rounded-lg"
              >
              ...
              <div className="flex flex-col sm:flex-row items-start sm:items-center gap-2 w-full sm:w-auto">
                ...
                <select
                  ...
                  className="w-full sm:w-auto px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-500 text-sm"
                >
